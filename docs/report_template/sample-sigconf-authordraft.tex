...
In figure [6], a bar chart showcases the number of medicines utilized associated with the most common side effects, like nausea, headaches and diarrhea, which consequently have the highest number of associated medications. This data shows a clear picture of the side effects that arise most frequently, and the amount of medication used to treat them.

\subsection{Common Uses Word Cloud}

The word cloud shown in figure [7] the most common uses of medicines. “Bacterial Infections” and ‘Hypertension’ are examples of uses that appear most prominently, indicating that these are the diseases most frequently treated with medicines in the dataset.
