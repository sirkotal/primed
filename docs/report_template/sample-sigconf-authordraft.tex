...
The gathered dataset contains about 110 lines of diseases, being available under the \textit{\textbf{Creative Commons Attribution-ShareAlike 4.0 International}} license\cite{wikipedia_cc}, which allows for the sharing and adaptation of the contents.
...
\begin{itemize}
	...
	\item {\texttt{Date}}: Date of when the drug was applied.
	\item {\texttt{Useful Count}}: Similar to likes, this provides the number of other people who found this review useful.
\end{itemize}
