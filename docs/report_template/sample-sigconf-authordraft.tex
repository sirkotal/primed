...
The Mean Average Precision defined using the P-R Curve as it provides the MAP value for the Simple Schema for Q4.
\[
MAP = 0.6376
\]
...
\begin{figure}[H]
  	...
  	\caption{Precision Recall Graph Simple Schema Query 4}
  	\Description{Dataset Characterization \textit{\textbf{PRIMED}}'s data}
