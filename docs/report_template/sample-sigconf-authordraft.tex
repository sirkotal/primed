...
\textbf{\textit{Q1}}:
\[
P@10_S = \frac{9}{10} = 0.9	,	P@10_A = \frac{5}{10} = 0.5
\]
\textbf{\textit{Q2}}:
\[
P@10_S = \frac{7}{10} = 0.7	,	P@10_A = \frac{4}{10} = 0.4
\]
\textbf{\textit{Q3}}:
\[
P@10_S = \frac{7}{10} = 0.7	,	P@10_A = \frac{2}{10} = 0.2
\]
\textbf{\textit{Q4}}:
\[
P@10_S = \frac{7}{10} = 0.7	,	P@10_A = \frac{0}{10} = 0
\]
...
\textbf{\textit{Q1}}:
\[
MAP_S = 0.8128	,	MAP_A = 0.2694
\]
\textbf{\textit{Q2}}:
\[
MAP_S = 0.6921	,	MAP_A = 0.2414
\]
\textbf{\textit{Q3}}:
\[
MAP_S = 0.7179	,	MAP_A = 0.0870
\]
\textbf{\textit{Q4}}:
\[
MAP_S = 0.6376	,	MAP_A = 0
\]
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{precision_recal_advanced_1.png}
  \caption{Q1 P-R Curve -> Advanced System}
  \Description{Q1 P-R Curve -> Advanced System}
  \label{fig:precisionRecalAdv1}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{precision_recal_advanced_2.png}
  \caption{Q2 P-R Curve -> Advanced System}
  \Description{Q2 P-R Curve -> Advanced System}
  \label{fig:precisionRecalAdv2}
\end{figure}
  
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{precision_recal_advanced_3.png}
	\caption{Q3 P-R Curve -> Advanced System}
	\Description{Q3 P-R Curve -> Advanced System}
	\label{fig:precisionRecalAdv3}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{precision_recal_advanced_4.png}
  \caption{Q4 P-R Curve -> Advanced System}
  \Description{Q4 P-R Curve -> Advanced System}
  \label{fig:precisionRecalAdv4}
\end{figure}
