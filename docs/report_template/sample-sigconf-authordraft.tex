...
The pipeline is composed of \texttt{Python} \textit{scripts} using libraries such as \texttt{pandas}, \texttt{unidecode}, \texttt{html}, \texttt{json} and \texttt{csv} with the crux of the data processing occurring on the \texttt{to{\textunderscore}json.py} script, to convert \texttt{CSV} files into \texttt{JSON} format.
