...
\begin{itemize}
	\item \texttt{q}: Returning of the normal query introduced by the user.
	\item \texttt{knn.q}: Contains the same content as the query-field from the normal semantic search.
\end{itemize}
