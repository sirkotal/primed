...
The final version of the dataset, representing the collection of documents, contains 11498 entries, where each one represents a drug, alongside all of its related information: reviews, their text and usefulness, manufacturer details, diseases and more text info about each of them and the previously discussed drug information.
...
\begin{itemize}
	...
	\item {\texttt{Excellent review percentage}}: Percentage of reviews with a rating bigger than 7.
	\item {\texttt{Average review percentage}}: Percentage of reviews with a rating between 4 and 7.
	\item {\texttt{Poor review percentage}}: Percentage of reviews with a rating under 4.
\end{itemize}
