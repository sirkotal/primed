...
The Average Precision is calculated for each query result, and the mean of these values across all relevant results is used to determine the Mean Average Precision, which in this case is obtained via the P-R Curve graph, as it provides the MAP value for all queries and systems.\newline
\textbf{\textit{Q1}}:
\[
